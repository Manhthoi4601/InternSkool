...
namespace IdentityCustom.Areas.Identity.Pages.Account.Manage
{
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                throw new InvalidOperationException($"Không thể tạo mã khôi phục cho người dùng vì chưa bật 2FA.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Người dùng có ID '{UserId}' đã tạo mã khôi phục 2FA mới.", userId);
